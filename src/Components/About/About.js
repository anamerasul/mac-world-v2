                ...
                <div className=''>
                    <div>
                        ...
                        <p className='text-gray-600'>
                            The first Macworld Expo occurred in 1985 in San Francisco. The conference itself was created by Peggy Kilburn,[9] who helped to increase the size and profit of the event during her tenure (1985–1999). Among the speakers recruited by Kilburn were David Pogue, Steve Case, Bob LeVitus, as well as representatives from BMUG, LaserBoard, and other major user groups.
                            ...
                            Since 1997, the show has been known for its keynote presentations (sometimes called "Stevenotes") delivered by Apple CEO Steve Jobs.
                        </p>
                        <p className='mt-10 mb-3 font-semibold text-gray-900'>
                            Culture
                        </p>
